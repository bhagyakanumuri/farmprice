...
const translations = {
 ...
 te: {'Login':'లాగిన్','Register':'నమోదు చేయండి','tagline_badge':'మెరుగైన లాభాల కోసం స్మార్ట్ వ్యవసాయం','hero_line1':'ఎప్పుడు అమ్మాలో తెలుసుకోండి','hero_line2':'మీ పంటలు అమ్మండి','hero_line3':'గరిష్ట లాభం కోసం','hero_desc':'AI ధర అంచనాలు మండి డేటా భారత రైతులకు ఒకే చోట.','get_started':'ఉచితంగా ప్రారంభించండి','top_price':'ఈరోజు అత్యుత్తమ ధర','rice_hyd':'వరి - హైదరాబాద్','trending_up':'పెరుగుతోంది','mandis_tracked':'మండీలు ట్రాక్','crop_varieties':'పంట రకాలు','farmers_helped':'రైతులకు సహాయం','prediction_accuracy':'అంచనా ఖచ్చితత్వం','how_helps':'FarmPrice మీకు ఎలా సహాయపడుతుంది','powerful_tools':'భారత రైతుల కోసం శక్తివంతమైన సాధనాలు','price_pred':'ధర అంచనా','price_pred_desc':'తదుపరి 15 రోజులకు AI అంచనాలు.','weather_advice':'వాతావరణ సలహా','weather_desc':'స్థానిక వాతావరణ ఆధారంగా సలహా.','marketplace':'మార్కెట్‌ప్లేస్','market_desc':'మీ పంటను జాబితా చేయండి మరియు కొనుగోలుదారులతో నేరుగా అనుసంధానించండి.','ready':'మంచి ధరలు పొందడానికి సిద్ధంగా ఉన్నారా?','join_farmers':'వేలాది రైతులు ఇప్పటికే FarmPrice ఉపయోగిస్తున్నారు','footer_tagline':'స్మార్ట్ ధర నిర్ణయంతో భారత రైతులను శక్తివంతం చేయడం'},
    hi: {'Login':'लॉग इन','Register':'पंजीकरण','tagline_badge':'बेहतर मुनाफे के लिए स्मार्ट खेती','hero_line1':'जानें कब बेचें','hero_line2':'अपनी फसल','hero_line3':'अधिकतम लाभ के लिए','hero_desc':'AI मूल्य पूर्वानुमान और मंडी डेटा भारतीय किसानों के लिए एक जगह।','get_started':'मुफ्त शुरू करें','top_price':'आज की सबसे अच्छी कीमत','rice_hyd':'चावल - हैदराबाद','trending_up':'बढ़ रहा है','mandis_tracked':'मंडियां ट्रैक','crop_varieties':'फसल की किस्में','farmers_helped':'किसानों की मदद','prediction_accuracy':'पूर्वानुमान सटीकता','how_helps':'FarmPrice कैसे मदद करता है','powerful_tools':'भारतीय किसानों के लिए शक्तिशाली उपकरण','price_pred':'मूल्य पूर्वानुमान','price_pred_desc':'अगले 15 दिनों के लिए AI पूर्वानुमान।','weather_advice':'मौसम सलाह','weather_desc':'स्थानीय मौसम पर आधारित सलाह।','marketplace':'बाज़ार','market_desc':'फसल सूचीबद्ध करें और खरीदारों से सीधे जुड़ें।','ready':'बेहतर कीमत पाने के लिए तैयार हैं?','join_farmers':'हजारों किसान पहले से FarmPrice उपयोग कर रहे हैं','footer_tagline':'स्मार्ट मूल्य निर्धारण से भारतीय किसानों को सशक्त बनाना'}
};
